...
], Like.prototype, "member_id", void 0);
__decorate([
    type_graphql_1.Field(() => Member_1.Member),
    typeorm_1.ManyToOne(() => Member_1.Member, (member) => member.id),
...
__decorate([
    ...
    typeorm_1.PrimaryColumn(),
    __metadata("design:type", String)
], Like.prototype, "schedule_id", void 0);
__decorate([
    type_graphql_1.Field(() => Schedule_1.Schedule),
    typeorm_1.ManyToOne(() => Schedule_1.Schedule, (schedule) => schedule.id, { onDelete: 'CASCADE' }),
    typeorm_1.JoinColumn({ name: 'schedule_id' }),
    __metadata("design:type", Schedule_1.Schedule)
], Like.prototype, "schedule", void 0);
Like = __decorate([
